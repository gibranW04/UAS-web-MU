                    ...
                    <div class="divide-y divide-slate-100">
                        ...
                        <div class="flex items-center gap-3 px-5 py-3">
                            <div class="w-12 h-12 rounded-lg bg-slate-50 flex-shrink-0 overflow-hidden">
                                ...
                                <img src="{{ $item->product->images->first()->image }}" alt="{{ $item->product->name }}" class="w-full h-full object-contain">
                                @else
                            ...
                            <form action="{{ route('user.wishlists.destroy', $item->id) }}" method="POST">
                                @csrf @method('DELETE')
                                <button class="p-1.5 rounded-lg text-slate-300 hover:text-red-500 hover:bg-red-50 transition-colors">
